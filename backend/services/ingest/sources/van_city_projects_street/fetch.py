"""
Fetch City Projects (Street) dataset metadata from the City of Vancouver Open Data API.
...
DEFAULT_DATASET_ID = "city-project-package-street"
...
def fetch_dataset_info(
	...
	*,
	...
	Args:
		dataset_id: Dataset identifier (e.g., city-project-package-street).
...
def fetch_raw_records(
	...
	*,
	...
	"""
	Fetch raw City Projects (Street) records from the Open Data API.
