...
def fetch_records(
    ...
    *,
    ...
    """
    Fetch dataset records for Road Ahead.
    Returns the raw response with total_count and results.
    """
...
def test_fetch() -> None:
    ...
    """
    select_fields = "project,street,location,comp_date,url_link"
    payload = fetch_records(select=select_fields)
