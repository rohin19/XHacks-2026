...
interface CommunityPostOldProps {
  post: {
...
export function CommunityPostOld({ post }: CommunityPostOldProps) {
  ...
  return (
    <article className="bg-white border border-[#E2E8F0] rounded-xl hover:border-[#CBD5E1] transition-all hover:shadow-lg group overflow-hidden">
      <div className="p-6">
        ...
        {/* Data Points */}
        <div className="bg-gradient-to-br from-[#F8FAFC] to-[#F1F5F9] rounded-xl p-5 space-y-2.5 border border-[#E2E8F0] shadow-inner mb-4">
        ...
        {/* Summary */}
        {post.summary && (
          <p className="font-['Inter',sans-serif] text-[15px] text-[#64748B] leading-relaxed italic">
            {post.summary}
          </p>
        )}
      </div>
